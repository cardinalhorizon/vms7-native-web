...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\SmartCARSNative\Http\Controllers';
    ...
    {
        $config = [
            'as'         => 'admin.smartcarsnative.',
            'prefix'     => 'admin/smartcarsnative',
    ...
    {
        $config = [
            'as'         => 'api.smartcarsnative.',
            'prefix'     => 'api/smartcarsnative',
